/*
  # Complete WANEC RH Database Schema
  ...
  1. New Tables
    ...
    - `equipements` - Equipment and assets management
    - `rations` - Meal planning and catering
    - `fournisseurs` - Suppliers and vendors
    - `recrutement` - Job postings and recruitment
    - `candidats` - Job candidates
    - `contrats` - Employee contracts
    ...
    - `annonces` - Company announcements
...
-- =============================
-- EVENEMENTS & REUNIONS (Create main tables first)
-- =============================
...
-- =============================
-- ANNONCES (Create main table first)
-- =============================
...
-- =============================
-- JUNCTION TABLES (Create after main tables)
-- =============================
