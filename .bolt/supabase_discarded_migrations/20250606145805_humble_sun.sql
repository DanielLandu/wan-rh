/*
  ...
  1. New Tables
    ...
    - `objectifs` - Employee objectives
    - `salaires` - Salary management
    - `primes` - Bonuses
    - `equipements` - Equipment tracking
    - `rations` - Food rations
    - `fournisseurs` - Suppliers
    - `recrutement` - Recruitment process
    - `contrats` - Contract management
    - `evenements` - Event management
    - `reunions` - Meeting management
    - `plaintes` - Complaints handling
    - `avertissements` - Warnings management
...
CREATE TABLE IF NOT EXISTS evenements (
    ...
    participants UUID[] REFERENCES employes(id),
    type TEXT,
    statut TEXT,
    budget NUMERIC
);
...
CREATE TABLE IF NOT EXISTS annonces (
    ...
    importance TEXT,
    departements_cibles UUID[] REFERENCES departements(id),
